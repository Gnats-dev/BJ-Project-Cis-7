...
void play(vector<player>& players) {
	...
	for (unsigned int i = 1; i < players.size(); i++) { //cycles through the players
	...
	*/
	...
	for (unsigned int i = 1; i < players.size(); i++) { //we cycle through all the players since each player plays on their own
		do {
